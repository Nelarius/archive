...
inline GLenum GetBindingTarget(GLenum type) {
    ...
    case GL_ELEMENT_ARRAY_BUFFER:       return GL_ELEMENT_ARRAY_BUFFER_BINDING;
        // for some reason, these are not available on ubuntu
    ...
    default:    LOG(narwhal::LogLevel::Error) << "An unknown GL binding target was queried!"; return 0;
    }
}
...
inline std::size_t SizeOfGlType(GLenum type) {
    ...
    default:    LOG(narwhal::LogLevel::Error) << "An unknown GL type was queried!"; return 0;
    }
}
