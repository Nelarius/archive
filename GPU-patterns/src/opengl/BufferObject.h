...
public:
     ...
     * @param target The type of target this buffer object will be bound to.
    ...
    inline GLuint  object() const { return object_; }
    inline GLenum  type() const { return type_; }

    /**
     * @brief Returns the element size, in bytes, of the stored buffer.
     */
    inline GLsizei size() const { return size_; }
