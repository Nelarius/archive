...
namespace {
    ...
    pg::Program*            gShader{ nullptr };
    pg::BufferObject*       gVbo{ nullptr };
    pg::VertexArrayObject*  gVao{ nullptr };
    pg::Texture*            gFont{ nullptr };
...
ImGuiRenderer::ImGuiRenderer(Window* window, Program* panel )
    : window_{window},
    panelShader_{panel} {
    initialize_();
    refCount_++;
